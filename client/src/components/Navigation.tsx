      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="sm:hidden w-full overflow-x-auto">
            <div className="flex items-center space-x-3 pb-2 min-w-max px-2">
              <Button
                variant={isActive('/') ? 'default' : 'ghost'}
                size="sm"
                onClick={() => setLocation('/')}
                className={`flex-shrink-0 flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 ${
                  isActive('/') 
              ...
              {categories.map((category) => (
                <Button
                  ...
                  className={`flex-shrink-0 flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 relative ${
