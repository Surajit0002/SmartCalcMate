...
import { Search, Calculator, TrendingUp, Heart, Activity, Beaker, Shuffle } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Explore our comprehensive collection of specialized calculators organized by category
          </p>
        </div>
